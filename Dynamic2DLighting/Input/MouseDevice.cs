...
namespace WarOfTheSeas.Input
{
    ...
    public class MouseDevice
    {
        ...
        public void Update()
        {
            ...
            movementVector.X = movementVector.X * (1.0f - smoothingFactor) + state.X * smoothingFactor;
            movementVector.Y = movementVector.Y * (1.0f - smoothingFactor) + state.Y * smoothingFactor;
