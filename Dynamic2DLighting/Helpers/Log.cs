...
namespace WarOfTheSeas.Helpers
{
    ...
    public class Log
    {
        ...
        static Log()
        {
            try
            {
                FileStream file = new FileStream(Dynamic2DLighting.Properties.Settings.Default.LogFilename,
                ...
                {
                    file.Close();
                    file = new FileStream(Dynamic2DLighting.Properties.Settings.Default.LogFilename,
